...
const removeUselessNodes = $ => {
    [
        ...
        'head link[rel="next"]',
        'head link[href="https://consentcdn.cookiebot.com"]',
        ...
        'script#plesk-livechat-js',
        'link#plesk-livechat-css',
        'div.livechat-button',
        'div.pul-popover--placement-top-end',
